            ...
            <div class="card mb-4">
                ...
                <?php else : ?>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="nama_app_absen" class="col-sm-4 col-form-label">Nama Aplikasi</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="timezone_absen" class="col-sm-4 col-form-label">Zona Waktu Presensi</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="absen_mulai" class="col-sm-4 col-form-label">Presensi Dimulai Jam</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                        ...
                        <div class="form-group row">
                            <label for="absen_sampai" class="col-sm-4 col-form-label">Batas Presensi Masuk</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="absen_pulang_sampai" class="col-sm-4 col-form-label">Presensi Pulang</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="lokasi_absensi" class="col-sm-4 col-form-label">Presensi Dengan Lokasi</label>
                            <div class="col-sm-8">
